                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="${pageContext.request.contextPath }/admin/category/all">Category</a></li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card-block">
                                <form class="form-horizontal form-material" action="${pageContext.request.contextPath }/admin/category/add" method="post">
